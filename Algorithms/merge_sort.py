...
def merge_sort_dict(dictionary):
    ...
    left_half = merge_sort_dict(left_half)            # recursive call for the left half
    right_half = merge_sort_dict(right_half)          # recursive call for the right half
 
    return merge_dict(left_half, right_half)          # merging the two sorted halves

def merge_dict(left_half, right_half):
    result = {}
