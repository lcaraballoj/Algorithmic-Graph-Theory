...
graphs = [hyper_graph, alphaCyclic, square_conformal, triangle, tetraedron] # List of hypergraphs
...
# print(graphs[3]())
# print(bool(GYO(graphs[3](), graphs[3]())))

# hypergraph = GYO(hyper_graph(), hyper_graph())
# # Alpha acyclic hypergraph
# alphaCyclic = GYO(alphaCyclic(), alphaCyclic())
# # Square Conformal (not alpha acyclic)
# squareConformal = GYO(square_conformal(), square_conformal())
# # Tetraedron Graph(not alpha acyclic)
# tetraedron = GYO(tetraedron(), tetraedron())
